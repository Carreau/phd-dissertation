...
mechanical properties of cells. Indeed, cell mechanics are a key
parameter that has crucial impact on cellular and organism function. Being able
to detect changes in the mechanical properties, and to understand the mechanism that
govern these changes  is an important step in the study of cellular behavior as well as in
differnetiating healthy from cancerous cells and tissue.
Understanding the mechanisms that are at the origin of cell motion and shape changes is
also a decisive step in controlling cell behavior, with the ultimate goal to prevent
cancer cell invasion and division without impairing healthy cells.
...
is able to form various different types of networks. I decided to focus my research on such networks that were created underder
...
collaboration with the group of Marie Helene Verlhac at College de France, we studied the mechanical properties
in the cytosole of mouse oocytes. We see in this system that actin related proteins have
...
cortixes that are linked to a lipid 
...
cells is the actin cytoskeleton, which is made up of actn monomers, a protein that is highly conserved across species and which plays
an important role for cell mechanics, ranging from cell migration to cell differentiation
and division. It plays hence a cruical role for the mechanical properties of
...
inhomogeneous. Optical traps allowe to probe the mechanics of yet unaccessible parts of
the network.
...
individual component it is neccessay to isolate or modify their actions
independently.
...
that may be added to the reconstituted system. Oftern this vast complexity
...
be highly reduced, still maintaining the mitility features. 
...
:math:`Pa`.  It is instructive to have an idea of the oder of magnitude of a
